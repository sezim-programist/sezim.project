...
namespace Курсавая
{
    public partial class Form8 : Form
    {
        ...
        {
            InitializeComponent();
            this._4_семестрDataGridView.Columns[0].Visible = false;
        }

        private void _4_семестрBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this._4_семестрBindingSource.EndEdit();
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "_3FormDataSet._4_семестр". При необходимости она может быть перемещена или удалена.
            this._4_семестрTableAdapter.Fill(this._3FormDataSet._4_семестр);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    // Save | Update
                    this._4_семестрBindingSource.EndEdit();
                    this._4_семестрTableAdapter.Update(this._3FormDataSet._4_семестр);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Update
                    this._4_семестрBindingSource.RemoveCurrent();
        ...
        {
            this._4_семестрBindingSource.AddNew();
        }
